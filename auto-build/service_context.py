...
Usage:
    ...
    python auto-build/service_context.py --service backend --output backend/SERVICE_CONTEXT.md

    # Generate for all services (using project index)
    python auto-build/service_context.py --all

    # Generate with custom project index
    python auto-build/service_context.py --service frontend --index auto-build/project_index.json
"""
