...
// Note: 'agent' settings moved to project-level settings
export type AppSection = 'appearance' | 'display' | 'language' | 'devtools' | 'paths' | 'integrations' | 'api-profiles' | 'updates' | 'notifications' | 'debug';
